...
async function startBackend(targetPort) {
  ...
  backend = spawn(pythonPath(), ['run_iot.py'], {
    ...
    env: {
      ...
      DISEASE_INFERENCE_SUBPROCESS: process.env.DISEASE_INFERENCE_SUBPROCESS || 'false',
      DISEASE_INFERENCE_TIMEOUT_SECONDS: process.env.DISEASE_INFERENCE_TIMEOUT_SECONDS || '60',
      DISEASE_MAX_ANALYSIS_EDGE: process.env.DISEASE_MAX_ANALYSIS_EDGE || '640',
      DISEASE_YOLO_IMGSZ: process.env.DISEASE_YOLO_IMGSZ || '320',
